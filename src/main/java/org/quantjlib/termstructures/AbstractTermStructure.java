...
package org.quantjlib.termstructures;

import org.quantjlib.QL;
import org.quantjlib.Settings;
import org.quantjlib.daycounters.Actual365Fixed;
import org.quantjlib.daycounters.DayCounter;
import org.quantjlib.math.Closeness;
import org.quantjlib.math.interpolations.DefaultExtrapolator;
import org.quantjlib.time.Calendar;
import org.quantjlib.time.Date;
import org.quantjlib.time.TimeUnit;
import org.quantjlib.util.DefaultObservable;
import org.quantjlib.util.Observable;
import org.quantjlib.util.Observer;
...
public abstract class AbstractTermStructure implements TermStructure {
     ...
     *
     * @see org.quantjlib.math.interpolations.Extrapolator
     */
